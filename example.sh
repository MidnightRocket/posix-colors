...
print "${T_ITALIC}ITALIC${TR} reset"
...
print "${T_STRIKE}STRIKE${TR} reset"
...
print "${TF_BRIGHT_GRAY}bright_gray${TR}\treset"
print "${TF_DARK_GRAY}dark_gray${TR}\treset"
print "${TF_BRIGHT_RED}bright_red${TR}\treset"
print "${TF_BRIGHT_GREEN}bright_green${TR}\treset"
print "${TF_BRIGHT_YELLOW}bright_yellow${TR}\treset"
print "${TF_BRIGHT_BLUE}bright_blue${TR}\treset"
print "${TF_BRIGHT_MAGENTA}bright_magenta${TR}\treset"
print "${TF_BRIGHT_CYAN}bright_cyan${TR}\treset"
...
print "${TB_BRIGHT_GRAY}bright_gray${TR}\treset"
print "${TB_DARK_GRAY}dark_gray${TR}\treset"
print "${TB_BRIGHT_RED}bright_red${TR}\treset"
print "${TB_BRIGHT_GREEN}bright_green${TR}\treset"
print "${TB_BRIGHT_YELLOW}bright_yellow${TR}\treset"
print "${TB_BRIGHT_BLUE}bright_blue${TR}\treset"
print "${TB_BRIGHT_MAGENTA}bright_magenta${TR}\treset"
print "${TB_BRIGHT_CYAN}bright_cyan${TR}\treset"
...
print "${TB_BRIGHT_GRAY}${TF_BLUE}BLue on bright_gray${TR}"
